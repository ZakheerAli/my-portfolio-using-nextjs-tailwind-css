        ...
        <div>
            ...
            <div className="w-full h-full text-center px-20 pt-28 pb-10 bg-white">
                ...
                <p className="text-lg mt-5 text-slate-500 font-bold">
                    "Hello! I’m Zakheer Ali, a front-end developer with a passion for creating impactful web experiences. 
                ...
                <p className="text-lg mt-5 text-slate-500 font-bold">
                    ...
                    like Next.js and Tailwind CSS. I’ve built a range of projects, from static websites to interactive applications, 
                ...
                <p className="text-lg mt-5 text-slate-500 font-bold">
                    ...
                    landing page with animations, I’ve developed a keen eye for design, usability, and efficient code. Recently, 
                    I've applied these skills in projects."
                </p>
                <p className="text-lg mt-5 text-slate-500 font-bold">
                    "Development Philosophy: I believe that great web development goes beyond aesthetics; it’s about creating seamless, 
                    enjoyable experiences for users. I’m dedicated to writing clean, maintainable code and implementing best practices 
                ...
                <p className="text-lg mt-5 text-slate-500 font-bold">
                    "I’m a continuous learner, always exploring the latest in web technologies to stay ahead in an ever-evolving 
