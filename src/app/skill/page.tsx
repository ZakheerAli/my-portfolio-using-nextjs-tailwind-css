...
export default function () {
    return (
        <div >
            <Navbar />
            <div className="flex items-center flex-col h-full justify-center w-full px-20 pt-28 bg-white" >
                <h1 className="text-7xl mb-20 mt-40 text-orange-500 font-extrabold">SKILLS</h1>
                ...
                <div className="w-1/3 flex items-center justify-center rounded-md bg-blue-400">
                    ...
                    <div className="w-5/6 h-5/6 cursor-pointer bg-white pt-14 hover:w-11/12 hover:h-11/12">
